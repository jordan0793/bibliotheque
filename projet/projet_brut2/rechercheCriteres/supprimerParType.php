    ...
    <form method="post">
        <fieldset>
            ...
            <div class="form-group">
                <label for="type" class="form-label mt-4">Entrer le genre du livre</label>
...
if (!empty($_POST)) {
    ...
    if (
        ...
        $sql = "SELECT id_li, titre_li, date_parution_li, resume_li, type_li, titre_li, auteur_li, nb_exemplaire_li FROM `livre` WHERE `type_li` LIKE CONCAT('%', :type, '%')";
