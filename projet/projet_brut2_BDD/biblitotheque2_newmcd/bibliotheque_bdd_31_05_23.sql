...
--
-- Hôte : localhost
-- Généré le : mer. 31 mai 2023 à 09:18
...
CREATE TABLE IF NOT EXISTS `livre` (
  ...
  `resume_li` varchar(10000) DEFAULT NULL,
...
(58, 'La Saignée', 2021, 'Une plongée dans un monde où chacun doit affronter ses démons.  «  Est-ce que tu aimes ?  » clame le site sous la photo d’un cadavre mutilé. Sur le Dark Web, il existe des espaces interdits au commun des mortels où les voyeurs de la pire espèce assouvissent leurs pulsions.  Estel Rochand a été écartée de la police à la suite d’une terrible bavure qui a causé la mort d’une innocente. Sa vie est en miettes, son couple à la dérive. Désormais garde du corps de seconde zone, cette ancienne championne de boxe se fraie un...', 'policier', 'Sir Cédric', 3),
(71, 'Plus jamais sans moi', 2023, 'Et s\'il était temps pour vous de rencontrer enfin le grand amour ?Constance, avocate brillante, a obtenu le poste qu\'elle convoitait dans un cabinet d\'élite. Pourtant, à l\'approche de la quarantaine, elle se sent fragile et peu sûre d\'elle. Très amoureuse de Lucas, elle attend que celui-ci quitte sa femme comme il le lui a promis. Alors qu\'elle vient de signer son contrat, Constance découvre qu\'elle doit effectuer une période d\'essai d\'un genre... peu conventionnel ! Soutenue par ses amis, elle accepte de s\'écarter...', 'romance', 'Maud Ankaoua', 2),
(72, 'Service Action - Louve Alpha', 2023, 'Fans du Bureau des légendes, retrouvez le Service Action, l&#039;unité spéciale de la DGSE en charge des opérations les plus secrètes, clandestines et illégales de la République.  &quot; Des romans passionnants et, sauf preuve du contraire, criants de vérité. &quot; Midi Libre ***  Projeté sur les missions les plus sensibles dans le conflit ukrainien, le Service Action, bras armé de la DGSE, s&#039;apprête, sur ordre du chef de l&#039;État, à punir en Afrique le groupe mercenaire Wagner, coupable des pires crimes de guerre. Mais le SA est au même moment ciblé par un nouveau danger immédiat : désormais, plus aucun de ses agents n&#039;est en sécurité dans le monde. Chef de l&#039;unité, le colonel Coralie Desnoyers, alias Athéna, se dresse en premier bouclier pour protéger son effectif menacé. De la brousse du Sahel aux ruines de Bakhmout, aucun répit pour Athéna, engagée dans une lutte à mort. Alors qu&#039;on la pensait tombée dans les oubliettes de l&#039;Histoire, une ombre maléfique frappe les ennemis de la Russie. La plus grande des terreurs est de retour.', 'policier', 'victor k', 1),
(73, 'Omerta', 2023, 'Écrivain à la dérive, John Harper apprend une nouvelle qui le bouleverse : son père, qu’il n’a jamais connu et croyait mort depuis longtemps, est bel et bien en vie. A la suite de graves blessures par balle, il a été transporté dans un hôpital de Manhattan. Et John n’est pas au bout de ses surprises : celui qui les a abandonnés, sa mère et lui, quand il n’avait que deux ans n’est pas n’importe qui, puisqu’il s’agit de Lenny Bernstein, l’un des pontes de la mafia new-yorkaise', 'policier', 'Roger Jon Ellory', 2),
(75, 'Les Masques éphémères', 2023, '« La trentième enquête du commissaire Brunetti est un véritable tour de force sur le crime organisé vénitien. »ICI PARISAu Campo Santa Margherita, un étrange accident de bateau impliquant deux jeunes touristes américaines éveille les soupçons du commissaire Brunetti. Les deux hommes qui les ont déposées devant l’hôpital ont disparu. Pourquoi ? Pour Brunetti, cela cache forcément quelque chose. Sillonnant les canaux sombres de Venise, il est bien décidé à faire toute la lumière sur cette affaire.Née dans le New Jersey, Donna...', 'policier', 'Donna Leon', 1),
(76, 'Harry Potter à l&#039;école des sorciers', 2000, 'Le jour de ses onze ans, Harry Potter, un orphelin élevé par un oncle et une tante qui le détestent, voit son existence bouleversée. Un géant vient le chercher pour l&#039;emmener à Poudlard, une école de sorcellerie ! Voler en balai, jeter des sorts, combattre les trolls : Harry révèle de grands talents. Mais un mystère entoure sa naissance et l&#039;effroyable V., le mage dont personne n&#039;ose prononcer le nom.', 'fantastique', 'jk rowling', 2),
(77, 'Ne t&#039;inquiète pas pour moi', 2022, 'Une correspondance par Post-it sur le frigo entre une mère et sa fille. Chaque jour, elles se parlent par messages interposés, de la simple note jetée pour rappeler de ne pas oublier d&#039;acheter le lait au message personnel et intime. Lorsque la mère tombe gravement malade, le temps presse mais l&#039;espoir demeure jusqu&#039;à la fin.', 'drame', 'Alice Kuipers', 1),
(79, 'Ne le dis pas à maman', 2011, 'J&#039;avais confiance en l&#039;amour de ma mère. Elle lui dirait d&#039;arrêter. Elle n&#039;en fit rien. T. M.L&#039;histoire bouleversante d&#039;une petite fille face à l&#039;inceste et à la trahison... Stupéfiant. Daily MirrorCet ouvrage édifiant est le témoignage de l&#039;extraordinaire courage de Toni Maguire. Closer Magazine', 'drame', 'Toni Maguire', 2);
...
(10, 'valerie@gmail.com', '$2y$10$g8Rd5nfFLZl2gjqeP6uwnujIJQBhpjVpomW1QlDfT/xaDSe7T9Knm', 'valerie', '[\"ROLE_USER\"]'),
(11, 'jean@gmail.com', '$2y$10$ic9pdaIf8qJJk0yEa/HSF.J5BVqk5zmTRd3W.3wXt3gcEViYbE8ES', 'jean', '[\"ROLE_USER\"]'),
(12, 'peter@gmail.com', '$2y$10$UIbYfM4oZMqdBUZA1neeO.MuXti4MPSpokQbH0D84WiE3DXXA.Zsq', 'peter', '[\"ROLE_USER\"]'),
(47, 'david@gamil.com', '$2y$10$SYoB5DQv5vYEx.nrTn0jmeB3e0IBAMnZ0Cj14EMP7uBhU62mbKF/2', 'david', '[\"ROLE_USER\"]'),
(48, 'bidule@gmail.com', '$2y$10$Rq36tzkwLJDoxwJynqzfzefLcRpBYhcxmb1d0WnzoFnbjLt8Le8Zm', 'bidule', '[\"ROLE_USER\"]'),
(49, 'dede@gmail.com', '$2y$10$1rli/JTVPPEJvqzVoBCmYueIjemQXLNdHJDkCXJIPzeM3dnBWBQYa', 'dede', '[\"ROLE_USER\"]'),
(50, 'gege@gmail.com', '$2y$10$SRdH/BdixVYcDD5VjXl/L.zYIjeHSSDhTStlbFvZwmrSke.z4Zhe6', 'gege', '[\"ROLE_USER\"]');
COMMIT;
