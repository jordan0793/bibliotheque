...
<div class="container">
    <form method="post">
        <fieldset>
            <legend>Rechercher un Genre de livre</legend>

            <div class="form-group">
                <label for="type" class="form-label mt-4">Entrer un Genre de livre</label>
...
?>
    ...
    <td>' . $value['nb_exemplaire_li']  . ' <button><a href="/rechercheCriteres/fonctions/modifierLivre.php?id=' . $value['id_li'] . '">Modifier</a></button>
    
     
    </tr>';
            }
        } else {
            die('<div class ="echec">Ce genre n\'est pas répertorié, Veuillez Reessayez</div>');
        }
    }
}
