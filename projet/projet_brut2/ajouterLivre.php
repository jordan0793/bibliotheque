...
<form method="post">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="dateDeParution" name="dateDeParution" aria-describedby="dateDeParution" placeholder="Entrer la date de parution">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exemplaire" name="exemplaire" aria-describedby="exemplaire" placeholder="Entrer le nombre d'exemplaire">
        </div>
